 ...
 */
export type McpElicitationSchema = { $schema?: string, type: McpElicitationObjectType, title?: string, description?: string, properties: { [key in string]?: McpElicitationPrimitiveSchema }, required?: Array<string>, };
